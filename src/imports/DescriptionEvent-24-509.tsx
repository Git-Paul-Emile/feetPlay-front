import svgPaths from "./svg-owvifdqhk";
...
function Group9() {
  return (
    <div className="absolute contents left-[1352px] top-[193px]">
      <div className="absolute backdrop-blur-[5px] content-stretch flex items-center justify-center left-[1352px] p-[8px] rounded-[28px] size-[48px] top-[193px]" data-name="CLOSE-2" style={{ backgroundImage: "linear-gradient(88.1659deg, rgba(255, 255, 255, 0.3) 0%, rgba(32, 11, 11, 0.3) 100%)" }}>
...
function Header() {
  return (
    <div className="absolute contents left-[-1px] top-[147px]" data-name="Header">
      <div className="absolute h-[807px] left-[-1px] top-[147px] w-[1440px]" data-name="photo2 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-full left-[-0.72%] max-w-none top-0 w-[101.36%]" src={imgPhoto21} />
        </div>
      </div>
      <div className="absolute bg-black h-[807px] left-[-1px] opacity-70 top-[147px] w-[1440px]" />
      <Group9 />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="absolute bg-[#161212] h-[184px] left-[-39px] overflow-clip top-[958px] w-[1518px]">
      <FooterBar />
    </div>
  );
}
...
function Group8() {
  return (
    <div className="absolute contents left-[-37px] top-0">
      <div className="absolute backdrop-blur-[21px] inset-[0_-4.38%_87.15%_-2.57%] opacity-80 rounded-[20px]" style={{ backgroundImage: "linear-gradient(167.249deg, rgba(255, 255, 255, 0.47) 0%, rgba(255, 255, 255, 0) 110.84%)" }}>
...
function Frame2() {
  return (
    <div className="col-1 content-stretch flex gap-[24px] items-center ml-[5px] mt-[92.04px] relative row-1">
      <Group2 />
      <Group3 />
      <Group4 />
    </div>
...
function SlliderDesc() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Sllider-Desc">
      <p className="col-1 font-['DM_Sans:Bold',sans-serif] font-bold h-[75px] leading-[1.25] ml-0 mt-0 relative row-1 text-[#fcc434] text-[54px] w-[1211px]" style={{ fontVariationSettings: "'opsz' 14" }}>
        Dadju- concert Montreal
      </p>
      <p className="col-1 font-['Poppins:Regular',sans-serif] h-[99.451px] leading-[normal] ml-[5px] mt-[149px] not-italic relative row-1 text-[18px] text-white w-[597px]">Gravity-defying bubbles rain down, cutting off Tokyo from the rest of the world. The city skyline becomes a playground for young people competing in parkour team battles. Hibiki plummets into the sea but is saved by a girl with mysterious powers.</p>
      <Frame2 />
    </div>
  );
}
...
function Group5() {
  return (
    <div className="font-['Inter:Medium',sans-serif] font-medium grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[18px] not-italic place-items-start relative shrink-0">
      <p className="col-1 h-[25.059px] ml-0 mt-0 relative row-1 text-[16px] text-[rgba(255,255,255,0.6)] w-[89px]">Date</p>
      <p className="col-1 h-[25.059px] ml-0 mt-[39.06px] relative row-1 text-[28px] text-[rgba(255,255,255,0.85)] w-[144px]">20 Nov</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="font-['Inter:Medium',sans-serif] font-medium grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[18px] not-italic place-items-start relative shrink-0">
      <p className="col-1 h-[25.059px] ml-0 mt-0 relative row-1 text-[16px] text-[rgba(255,255,255,0.6)] w-[89px]">Heure</p>
      <p className="col-1 h-[24px] ml-0 mt-[39.06px] relative row-1 text-[28px] text-[rgba(255,255,255,0.85)] w-[144px]">15:05</p>
    </div>
  );
}
...
function Group7() {
  return (
    <div className="font-['Inter:Medium',sans-serif] font-medium grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[18px] not-italic place-items-start relative shrink-0">
      <p className="col-1 h-[25px] ml-0 mt-0 relative row-1 text-[14px] text-[rgba(255,255,255,0.6)] w-[144px]">Référence</p>
      <p className="col-1 h-[24px] ml-0 mt-[39px] relative row-1 text-[28px] text-[rgba(255,255,255,0.85)] w-[216px]">F25L11-30</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex gap-[35px] items-center relative shrink-0">
      <Group5 />
      <div className="flex h-[107px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
          ...
          <div className="h-0 relative w-[107px]">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 107 1">
                <line id="Line 8" stroke="var(--stroke-0, white)" x2="107" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
...
function CtaAchat() {
  return (
    <div className="bg-[#de0035] content-stretch flex gap-[14px] h-[58px] items-center justify-center px-[40px] py-[8px] relative shrink-0 w-[194px]" data-name="CTA - ACHAT">
...
function CtaAchat1() {
  return (
    <div className="bg-[#de0035] content-stretch flex gap-[14px] h-[58px] items-center justify-center px-[40px] py-[8px] relative shrink-0 w-[252px]" data-name="CTA - ACHAT">
      <div className="overflow-clip relative shrink-0 size-[40px]" data-name="ticket / 24 / Outline">
        <div className="absolute inset-[20.83%_8.33%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 33.3333 23.3333">
            <path d={svgPaths.p310a8700} fill="var(--fill-0, white)" id="Vector" />
      ...
      <div className="flex flex-col font-['SF_Pro:Regular',sans-serif] font-normal h-[34px] justify-center leading-[0] relative shrink-0 text-[26px] text-white w-[154px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[32px]">Voir l’annonce</p>
      </div>
    </div>
  );
}
...
function Cta() {
  return (
    <div className="content-stretch flex gap-[24px] h-[56px] items-center justify-center relative shrink-0 w-[473px]" data-name="CTA">
      <CtaAchat />
      <CtaAchat1 />
...
function Frame4() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[42px] items-start left-[117px] top-[calc(50%-0.27px)] w-[1211px]">
      <SlliderDesc />
      <Frame3 />
      <Cta />
    </div>
...
export default function DescriptionEvent() {
  return (
    <div className="bg-black relative size-full" data-name="DESCRIPTION EVENT">
      <Header />
      <Frame1 />
      <Group8 />
      <Frame4 />
