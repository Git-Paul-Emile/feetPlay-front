import svgPaths from "./svg-q0gpkdtxqd";
...
import { imgImage15 } from "./svg-v7hku";
...
function Navbar() {
  return (
    <div className="absolute content-stretch flex h-[90px] items-center justify-between left-[-10px] px-[75px] py-[24px] top-[47.02px] w-[1512px]" data-name="Navbar">
...
function Group62() {
  return (
    <div className="absolute contents left-[-16px] top-0">
      <div className="absolute backdrop-blur-[21px] inset-[0_-0.79%_97.01%_-1.06%] opacity-80 rounded-[20px]" style={{ backgroundImage: "linear-gradient(167.651deg, rgba(255, 255, 255, 0.47) 0%, rgba(255, 255, 255, 0) 110.84%)" }}>
...
function BesstOf() {
  return (
    <div className="-translate-x-1/2 absolute h-[628px] left-[calc(45.83%+45px)] overflow-clip top-[571px] w-[1464px]" data-name="BESST OF">
...
function Frame72() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[43px] top-[1223px] w-[1433px]">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[1.005] not-italic relative shrink-0 text-[48px] text-white w-[585px]">{`Ce mois `}</p>
      <Frame73 />
    </div>
  );
}
...
function List() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-center left-[43px] top-[1357px]" data-name="LIST">
      <Component />
      <Component3 />
      <Component6 />
      <Component9 />
...
function List1() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-center left-[39px] top-[2125px]" data-name="LIST">
      <Component18 />
      <Component21 />
      <Component24 />
      <Component27 />
...
function VuesaxLinearCalendar12() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/calendar">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="calendar">
...
function VuesaxLinearCalendar13() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/calendar">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="calendar">
...
function VuesaxLinearCalendar14() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/calendar">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="calendar">
...
function VuesaxLinearCalendar15() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/calendar">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="calendar">
...
function VuesaxLinearCalendar16() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/calendar">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="calendar">
...
function VuesaxLinearCalendar17() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/calendar">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="calendar">
...
function List2() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-center left-0 top-[3009px]" data-name="LIST">
      <Component36 />
      <Component39 />
      <Component42 />
      <Component45 />
...
function Frame34() {
  return (
    <div className="absolute bg-[#161212] h-[520px] left-0 overflow-clip top-[4224px] w-[1518px]">
      <Group41 />
      <FooterBar />
    </div>
  );
...
function Group42() {
  return (
    <div className="absolute contents inset-[36.54%_78.86%_36.54%_4.11%]">
      <p className="absolute font-['Urbanist:Light',sans-serif] font-light inset-[36.54%_78.86%_36.54%_4.11%] leading-[normal] text-[#cdff71] text-[12px]">Events, Attraction, Playground, ....</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="absolute content-stretch flex gap-[14px] h-[55px] items-center left-[53px] top-[236px] w-[2481px]" data-name="label">
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none rotate-180">
...
function Frame74() {
  return (
    <div className="absolute bg-[#121212] h-[429px] left-[-2px] overflow-clip top-[142px] w-[1512px]">
      <div className="absolute h-[52px] left-[228px] top-[88px] w-[1056px]" data-name="RECHERCHE">
        <div className="absolute inset-[0_0_0_5.59%]" data-name="research  barre2/Par défaut">
...
function Frame75() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[39px] top-[2901px] w-[1433px]">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[1.005] not-italic relative shrink-0 text-[48px] text-white w-[585px]">Le mois prochain</p>
      <Frame76 />
    </div>
  );
}

export default function EnLive() {
  return (
    <div className="bg-black relative size-full" data-name="En Live">
      <Group19 />
      <Group20 />
      <Group21 />
      ...
      <List1 />
      <List2 />
      <div className="-translate-x-1/2 absolute h-[346px] left-[calc(45.83%+48.5px)] top-[3777px] w-[1405px]" data-name="annonce slider">
