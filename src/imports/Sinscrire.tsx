import svgPaths from "./svg-viq7b511hn";
  ...
  return (
    <div className="absolute contents left-[calc(100%+928px)] top-[907px]">
      <div className="absolute flex inset-[907px_-1237px_338px_calc(100%+928px)] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[355px] w-[309px]">
  ...
  return (
    <div className="absolute contents left-[calc(100%+928px)] top-[907px]">
      ...
      <div className="absolute flex inset-[907px_-1237px_337px_calc(100%+928px)] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[356px] w-[309px]">
          <div className="bg-gradient-to-b from-[15.778%] from-[rgba(29,29,29,0)] size-full to-[rgba(29,29,29,0.78)]" data-name="overlay" />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="absolute contents inset-[907px_-1572px_338px_calc(100%+1262px)]">
      <div className="absolute flex inset-[907px_-1572px_338px_calc(100%+1262px)] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[355px] w-[310px]">
          <div className="bg-gradient-to-b from-[15.778%] from-[rgba(29,29,29,0)] size-full to-[rgba(29,29,29,0.78)]" data-name="overlay" />
        </div>
      </div>
      <div className="absolute flex inset-[907px_-1572px_338px_calc(100%+1262px)] items-center justify-center">
...
function Group15() {
  return (
    <div className="absolute contents left-[-10px] top-0">
      <div className="absolute backdrop-blur-[21px] inset-[0_-1.19%_89.67%_-0.66%] opacity-80 rounded-[20px]" style={{ backgroundImage: "linear-gradient(165.695deg, rgba(255, 255, 255, 0.47) 0%, rgba(255, 255, 255, 0) 110.84%)" }}>
...
function Frame6() {
  return (
    <div className="absolute bg-[#161212] h-[184px] left-0 overflow-clip top-[1416px] w-[1518px]">
      <FooterBar />
    </div>
  );
}
...
function PhoneRinging1AndroidPhoneMobileDeviceSmartphoneIphoneRingingIncomingCall() {
  return (
    <div className="absolute inset-[3.57%_3.71%_3.57%_3.57%]" data-name="phone-ringing-1--android-phone-mobile-device-smartphone-iphone-ringing-incoming-call">
      <div className="absolute inset-[-3.37%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23.7526 23.7853">
          <g id="phone-ringing-1--android-phone-mobile-device-smartphone-iphone-ringing-incoming-call">
            <path d={svgPaths.p1e5f1170} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p303e9e00} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p2a135fe8} id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </g>
        </svg>
      </div>
    </div>
...
function Frame7() {
  return (
    <div className="content-stretch flex items-start relative shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal h-[18px] leading-[normal] not-italic relative shrink-0 text-[#adb3bc] text-[12px] text-center tracking-[-0.48px] w-[152px]">{`Vous avez déjà un compte ? `}</p>
      <div className="h-[22px] relative shrink-0 w-[94px]" data-name="link-login">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold inset-[0_0_18.18%_0] leading-[normal] not-italic text-[12px] text-[red] text-right tracking-[-0.48px]">Connectez-vous</p>
      </div>
    </div>
  );
}
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-end justify-center relative shrink-0 w-full" data-name="List">
      <div className="h-[62px] relative rounded-[43px] shrink-0 w-full" data-name="Fields">
        <div className="overflow-clip relative rounded-[inherit] size-full">
          <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[24px] leading-[normal] left-[23px] not-italic text-[#adb3bc] text-[18px] top-[19px] tracking-[-0.72px] w-[344px]">Prénom(s)</p>
        </div>
        <div aria-hidden="true" className="absolute border border-[#cdff71] border-solid inset-0 pointer-events-none rounded-[43px]" />
      </div>
      <div className="h-[62px] relative rounded-[43px] shrink-0 w-full" data-name="Fields">
        <div className="overflow-clip relative rounded-[inherit] size-full">
          <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[24px] leading-[normal] left-[23px] not-italic text-[#adb3bc] text-[18px] top-[19px] tracking-[-0.72px] w-[344px]">Nom</p>
        </div>
        <div aria-hidden="true" className="absolute border border-[#cdff71] border-solid inset-0 pointer-events-none rounded-[43px]" />
      </div>
      <div className="h-[62px] relative rounded-[43px] shrink-0 w-full" data-name="Mail">
        <div aria-hidden="true" className="absolute border border-[#cdff71] border-solid inset-0 pointer-events-none rounded-[43px]" />
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[10px] items-center px-[20px] py-[33px] relative size-full">
            ...
            <p className="font-['Inter:Regular',sans-serif] font-normal h-[24px] leading-[normal] not-italic relative shrink-0 text-[#adb3bc] text-[18px] tracking-[-0.72px] w-[220px]">Adresse E-mail</p>
          </div>
        </div>
      </div>
      <div className="h-[62px] relative rounded-[43px] shrink-0 w-full" data-name="Phone number">
        <div aria-hidden="true" className="absolute border border-[#cdff71] border-solid inset-0 pointer-events-none rounded-[43px]" />
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[10px] items-center px-[20px] py-[33px] relative size-full">
            <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Mail/Variante3">
              <PhoneRinging1AndroidPhoneMobileDeviceSmartphoneIphoneRingingIncomingCall />
            </div>
            <div className="flex h-[34px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
              <div className="flex-none rotate-90">
                <div className="h-0 relative w-[34px]">
            ...
            <p className="font-['Inter:Regular',sans-serif] font-normal h-[24px] leading-[normal] not-italic relative shrink-0 text-[#adb3bc] text-[18px] tracking-[-0.72px] w-[220px]">Numéro de téléphone</p>
          </div>
        </div>
      </div>
      <Frame7 />
...
function Inscription() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[calc(33.33%+66px)] top-[583px] w-[390px]" data-name="Inscription">
      <p className="font-['Inter:Regular',sans-serif] font-normal h-[24px] leading-[22.933px] not-italic relative shrink-0 text-[20px] text-white tracking-[-0.6px] w-full">Entre tes prénom(s) et nom à l’état civil</p>
      <List />
    </div>
  );
}
...
function Group14() {
  return (
    <div className="absolute contents left-[calc(33.33%+66px)] top-[583px]">
      <Inscription />
    </div>
  );
}
...
function Button() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-center justify-center left-[calc(50%+9px)] py-[48px] top-[997px] w-[430px]" data-name="Button">
      <div className="bg-[#eee5ff] content-stretch flex items-center justify-center px-[10px] py-[20px] relative rounded-[43px] shrink-0 w-[390px]" data-name="se connecter">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[18px] text-black text-center tracking-[-0.72px] whitespace-nowrap">{`S’inscrire `}</p>
      </div>
    </div>
  );
}
...
function Group13() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[normal] not-italic place-items-start relative shrink-0 text-[20px] whitespace-nowrap">
      <p className="col-1 font-['Inter:Extra_Bold',sans-serif] font-extrabold ml-[54px] mt-0 relative row-1 text-[rgba(255,255,255,0.5)]">Ou</p>
      <p className="col-1 font-['Inter:Medium',sans-serif] font-medium ml-0 mt-[49px] relative row-1 text-white">{`S’inscrire avec `}</p>
    </div>
  );
}
...
function List1() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[24px] items-center left-[calc(50%+9px)] top-[1155px] w-[170px]" data-name="List">
      <Group13 />
      <Group12 />
    </div>
  );
...
function Group17() {
  return (
    <div className="-translate-x-1/2 absolute contents left-[calc(50%+9px)] top-[431px]">
      <div className="absolute bg-[#f3f2f8] h-[763px] left-[calc(33.33%+46px)] overflow-clip top-[431px] w-[430px]" data-name="login">
        ...
        <div className="-translate-x-1/2 absolute bottom-[87.88%] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] left-1/2 not-italic text-[36px] text-center text-white top-[5.79%] tracking-[-2.16px] w-[430px]">
          <p className="leading-[41px]">S’inscrire</p>
        </div>
      </div>
      <Group14 />
      <Button />
...
function Group16() {
  return (
    <div className="absolute contents left-[calc(91.67%-7px)] top-[209px]">
      <div className="absolute backdrop-blur-[5px] content-stretch flex items-center justify-center left-[calc(91.67%-7px)] p-[8px] rounded-[28px] size-[48px] top-[209px]" data-name="CLOSE-2" style={{ backgroundImage: "linear-gradient(88.1659deg, rgba(255, 255, 255, 0.3) 0%, rgba(32, 11, 11, 0.3) 100%)" }}>
...
export default function Sinscrire() {
  return (
    <div className="bg-black relative size-full" data-name="S'inscrire">
      <Group9 />
      <Group10 />
      <Group11 />
      ...
      <Group17 />
      <Group16 />
      <div className="-translate-x-1/2 absolute h-[51px] left-1/2 top-[297px] w-[202px]" data-name="logo">
        <Group3 />
        <Group4 />
      </div>
    </div>
