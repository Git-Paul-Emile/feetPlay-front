    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-10 max-w-4xl">
        <Section title={<><Building2 className="w-5 h-5 text-gray-400" /> 1. Éditeur de la plateforme</>}>
          <p>La plateforme FeetiPlay est éditée par :</p>
          <InfoGrid items={[
            ['Raison sociale', 'FeetiPlay SAS'],
        ...
        <Section title={<><Server className="w-5 h-5 text-gray-400" /> 2. Hébergement</>}>
          <p>La plateforme FeetiPlay est hébergée par :</p>
        ...
        <Section title={<><Copyright className="w-5 h-5 text-gray-400" /> 3. Propriété intellectuelle</>}>
          <p>L'ensemble des éléments composant la plateforme FeetiPlay (marque, logo, chartes graphiques, textes, images, vidéos, flux de streaming, bases de données, logiciels) sont la propriété exclusive de FeetiPlay SAS ou de ses partenaires, et sont protégés par les droits de la propriété intellectuelle applicables en zone OHADA.</p>
        ...
        <Section title={<><LinkIcon className="w-5 h-5 text-gray-400" /> 4. Liens hypertextes</>}>
          <p>La plateforme FeetiPlay peut contenir des liens vers des sites externes fournis à titre informatif. FeetiPlay ne saurait être responsable du contenu ou des pratiques de ces sites tiers.</p>
          <p>Toute demande d'autorisation pour créer un lien pointant vers FeetiPlay doit être adressée à : <a href="mailto:contact@feetiplay.com" className="text-blue-400 hover:underline">contact@feetiplay.com</a></p>
        </Section>

        <Section title={<><AlertTriangle className="w-5 h-5 text-amber-400" /> 5. Limitation de responsabilité</>}>
          <p>FeetiPlay s'engage à faire ses meilleurs efforts pour assurer la disponibilité et la qualité du service de streaming. Cependant, FeetiPlay décline toute responsabilité en cas de :</p>
          <div className="bg-amber-900/20 border border-amber-500/30 rounded-lg p-4">
            <ul className="space-y-2">
              {[
                'Interruption temporaire pour maintenance ou mise à jour',
                'Problème de qualité réseau indépendant de FeetiPlay',
        ...
        <Section title={<><Scale className="w-5 h-5 text-gray-400" /> 6. Droit applicable</>}>
          <p>La plateforme FeetiPlay et ses mentions légales sont régies par le droit de la République du Congo et les Actes Uniformes de l'OHADA. Tout litige relatif à l'utilisation de la plateforme sera soumis à la juridiction compétente du ressort du siège social de FeetiPlay.</p>
        </Section>
        ...
        <Section title={<><Mail className="w-5 h-5 text-gray-400" /> 7. Contact</>}>
          <div className="bg-white/5 rounded-lg p-5 space-y-3">
            ...
            <div>
              ...
              <div className="text-white">[Adresse complète de FeetiPlay]</div>
            </div>
          </div>
        </Section>
        ...
        <div className="bg-gradient-to-r from-slate-700 to-slate-900 rounded-xl p-8 text-center mt-8 border border-white/10">
          ...
          <p className="text-gray-400 mb-6 max-w-xl mx-auto text-sm">Ces mentions légales garantissent la transparence et la conformité de FeetiPlay avec la législation en vigueur.</p>
